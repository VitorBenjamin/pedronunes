    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        ...
        {{-- <div class="carousel-item">
          <div class="row justify-content-center">
            <div class="col-sm-6 col-md-offset-1 col-md-5">
              <p class="slide-texto">asdkaslkdjaskldjlasjdlasjdlasjdl
                asdasdkaslkdjaskldjlasjdlasjdlasjdl
                asdasdkaslkdjaskldjlasjdlasjdlasjdl
                asdasdkaslkdjaskldjlasjdlasjdlasjdl
                asdasdkaslkdjaskldjlasjdlasjdlasjdl
                asdasdkaslkdjaskldjlasjdlasjdlasjdl
      ...
      <div class="setas">
        <a class="carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev">
          ...
          <img class="glyphicon glyphicon-chevron-left" src="{{asset('assets/img/seta-esq.svg')}}" alt="asdasd">
          <span class="sr-only">Previous</span>
        </a>
        <a class="carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next">
          {{-- <span class="carousel-control-next-icon" aria-hidden="true"></span> --}}
          <img class="glyphicon glyphicon-chevron-right" src="{{asset('assets/img/seta-dir.svg')}}" alt="asdasd">
